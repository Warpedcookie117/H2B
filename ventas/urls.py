...
# POS
from ventas.views.pos_views import pos_view, procesar_venta, stock_productos, set_dueno_servicios, producto_card
...
urlpatterns = [
    ...
    path("pos/producto-card/<int:producto_id>/", producto_card, name="producto_card"),
